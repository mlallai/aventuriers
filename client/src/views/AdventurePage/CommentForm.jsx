     ...
     return (
        ...
        <div>
            ...
            {user.avatar?
                    ...
                    :
                    <Avatar style={{backgroundColor: "#ffcc00"}}>{user.defaultAvatar}</Avatar>
                  }
            {/* <Media
                      ...
                      {/* // footer={ */}
                        ...
                        >
                          <span style={{textTransform: 'uppercase', color: 'black', fontWeight: 'bold'}}>commenter</span>
                        </Button>
            {/* //           }
            // /> */}
            </GridItem>
...
export default connect(mapStateToProps, { addComment })(withStyles(productStyle)(CommentForm));