...
class AlertMessageModal extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
                 {/* BUTTON SMALL MODAL */}
                 <Button onClick={() => this.handleClickOpen("smallModal")} round color="default">
                 <MailOutline style={{color: '#ffffff'}} /><span style={{color: "#ffffff"}}>Contacter</span>
                 </Button>
                  {/* SMALL MODAL START */}
                  <Dialog
                    classes={{
...
export default connect(mapStateToProps, { loginUser })(withStyles(javascriptStyles)(withRouter(AlertMessageModal)));
