                  ...
                  <Card plain blog>
                    <div>
                      <CardHeader plain image style={{position: 'relative', textAlign:'center'}}>
                        ...
                        <div style={{width: '100%'}}>
                              {adv.pictures[0] ?
                              <Link to={`/adventure/${adv._id}`} ><img src={adv.pictures[0]} alt="..." /></Link>
                              :
                              <Link to={`/adventure/${adv._id}`} ><img style={{minHeight: '170px'}} src={adv.defaultPictures[0]} alt="..." /></Link>}
                        </div>
    ...
    return (
      <div>
          ...
          <div className={classes.container}>
            <GridContainer>
              <GridItem xs={12} sm={6} md={6}>
                <h1 style={{fontSize: '45px'}} className={classes.title}>La plateforme de l'aventure <br /> responsable.</h1>
                <h3>
                  Adventurer est le premier site communautaire d'échange et de partage entre passionnés de sports outdoor.
                </h3>
                <br />
                <Link to="/adventures">
                  <Button
                    ...
                    // target="_blank"
                  >
                    <span style={{color: 'black'}}>Rechercher une aventure</span>
                  </Button>
                </Link>
              </GridItem>
            </GridContainer>
        ...
        <GridContainer justify="center">
          <GridItem>
          <h2 className={classes.title} style={{color: "#3C4858"}}>Dernières aventures proposées</h2>
          </GridItem>
        </GridContainer>
          <GridContainer>
                  {adventureLandingItem}
          </GridContainer>
        </div>
          <div className={classes.container}>
            <Features />
            <GridContainer justify="center">
            <GridItem>
            <h2 className={classes.title} style={{color: "#3C4858"}}>Tous les sports outdoor</h2>
            </GridItem>
          </GridContainer>
            <GridContainer>
            <GridItem xs={12} sm={6} md={6}>
              ...
              >
                <CardBody background>
                  <a href="#" onClick={e => e.preventDefault()}>
                    ...
                    <h6 style={{color: "#ffffff"}}>Randonnée, Trail, Alpinisme</h6>
                  </a>
                  <Link to={`/adventures`}>
                  <Button round color="warning">
                    <Search />Trouver mon projet
                  </Button>
                  </Link>
                </CardBody>
              </Card>
              ...
              >
                <CardBody background>
                  <a href="#" onClick={e => e.preventDefault()}>
                    ...
                    <h6 style={{color: "#ffffff"}}>Surf, voile, kitesurf, planche à voile</h6>
                  </a>
                  <Link to={`/adventures`}>
                  <Button round color="warning">
                    <Search />Trouver mon projet
              ...
              >
                <CardBody background>
                  <a href="#" onClick={e => e.preventDefault()}>
                    ...
                    <h6 style={{color: "#ffffff"}}>Treks, voyage à vélo, voyage à cheval</h6>
                  </a>
                  <Link to={`/adventures`}>
                  <Button round color="warning">
                    <Search />Trouver mon projet
...
export default connect(mapStateToProps, { getLatestAdventures })(withStyles(landingPageStyle)(LandingPage));
