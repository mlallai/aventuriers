...
import { getUserAdventures, deleteAdventure, getWishedAdventures } from '../../actions/adventureActions';
...
class ProfilePage extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (profile.profile) {
      ...
      this.setState({ loadedProfileExperience: loadedProfileExperience, loadedProfileSports: loadedProfileSports, newProfile: newProfile });
    }
    else {
      this.setState({loadedProfileExperience: [], loadedProfileSports: [], newProfile: {} })
    }
  ...
  render() {
    ...
    const { loadedProfileExperience, loadedProfileSports, newProfile, loadedUserAdventures, wishedAdventures } = this.state;
                      ...
                      <CardHeader plain image style={{position: 'relative', textAlign:'center'}}>
                        ...
                        <div style={{width: '100%'}}>
                            ...
                            {adv.pictures[0] ?
                              ...
                              :
                              <img style={{minHeight: '160px'}} src={adv.defaultPictures[0]} alt="..." />}
                            </Link>
                        </div>
                    ...
                    <CardBody plain>
                      ...
                      <h6 className={classes.cardCategory}>{adv.mainActivity} - {adv.location}<br/><span style={{color: '#9c27b0'}}>Niveau {adv.level}</span></h6>
                        ...
                        <Link to={`/adventure/${adv._id}`}>
                            ...
                            <h3 style={{fontSize: '1.4em', fontWeight: 'normal', color: "#3C4858", marginTop: '0', marginBottom: '0', minHeight: '65px'}} className={classes.cardTitle}>{adv.title}</h3>
                        </Link>
                          {/* {adv.summary ?
                          <div>
                      ...
                      <br/>
                      <Button color="default" size="sm" onClick={()=>{this.props.deleteAdventure(adv._id)}}><span style={{color: '#ffffff', fontWeight: 'bold'}}>Supprimer</span></Button>
                      </div>
                    </CardBody>
                  </Card>
      </GridItem>
    ...
    experience = loadedProfileExperience.map(exp => (
      <GridItem xs={12} sm={4} md={4}>
        <Card plain blog>
                    <div>
                      <CardHeader plain image style={{position: 'relative', textAlign:'center'}}>
                        ...
                        {exp.pictures[0] ?
                              ...
                              :
                              <img style={{minHeight: '160px'}} src={exp.defaultPictures[0]} alt="..." />}
                        </div>
                        <div style={{position: 'absolute', top: '0px', left: '2px'}}>
                        <GridContainer>
                            <GridItem xs={6}>
                            {exp.from ? <Badge color="warning"><span style={{color: 'black'}}><Moment format={'DD/MM/YY'}>{exp.from}</Moment></span></Badge> : <Badge color="warning"><span style={{color: 'black'}}>A DEFINIR</span></Badge>}
                            </GridItem>
                            <GridItem xs={6}>
                              {exp.eco ? {EcoBadge} : ''}
                          </GridItem>
                    ...
                    <CardBody plain>
                      <Info>
                      <h6 className={classes.cardCategory}>{exp.mainActivity} - {exp.location}<br/><span style={{color: '#9c27b0'}}>Niveau {exp.level}</span></h6>
                
                      </Info>
                      <h3 style={{fontSize: '1.4em', color: "#3C4858", fontWeight: 'normal', marginTop: '0', marginBottom: '0', minHeight: '70px'}} className={classes.cardTitle}>{exp.title}</h3>
                      {exp.summary ?
                          <div>
                            <p style={{marginBottom: '0', height: '50px', overflow: 'scroll'}} className={classes.description}>
                            {exp.summary}
                          ...
                          : ''}
                      <div>
                      <Button color="default" size="sm" onClick={()=>{this.props.deleteExperience(exp._id)}}><span style={{color: '#ffffff', fontWeight: 'bold'}}>Supprimer</span></Button>
                      </div>
                    </CardBody>
                  </Card>
      </GridItem>
                    ...
                    <CardBody plain>
                      ...
                      <h6 className={classes.cardCategory}>{adv.mainActivity} - {adv.location}<br/><span style={{color: '#9c27b0'}}>Niveau {adv.level}</span></h6>
                        ...
                        <Link to={`/adventure/${adv._id}`} onClick={e => e.preventDefault()}>
                            ...
                            <h3 style={{fontSize: '1.4em', color: "#3C4858", fontWeight: 'normal', marginTop: '0', marginBottom: '0', minHeight: '65px'}} className={classes.cardTitle}>{adv.title}</h3>
                        </Link>
                        {/* {adv.summary ?
                          <div>
                            <p style={{marginBottom: '0', height: '50px', overflow: 'scroll'}} className={classes.description}>
    ...
    if (Object.keys(newProfile).length > 0) {
      ...
      <Button
                    ...
                    // target="_blank"
                  >
      <Link to ="/edit-profile"><span style={{color: 'black'}}><Edit />Editer mon profil</span>
      </Link>
      </Button>
    } else {
      profileBtn = 
      <Button
                    ...
                    // target="_blank"
                  >
      <Link to="/create-profile"><span style={{color: 'black'}}>Créer mon profil</span>
      </Link>
      </Button>
      ;
    }
        ...
        >
          <div className={classes.container}>
            <GridContainer style={{justifyContent: 'center', textAlign: 'center' }}>
                ...
                <GridContainer style={{justifyContent: 'center', textAlign: 'center', padding: '10px', margin: '10px', border: '1px solid rgba(232, 236, 241, 1)', borderRadius: '8px'}}>
                    <GridItem md={12} sm={12} style={{justifyContent: 'center', textAlign: 'center'}}>
                        <GridContainer style={{alignItems: 'center', textAlign: "center", justifyContent: 'center'}}>
                        {user.avatar?
                    <GridItem><Avatar alt="" src={user.avatar} /></GridItem>
                    :
                    <GridItem style={{display: 'inline', alignItems: 'center'}}><GridContainer style={{justifyContent: 'center', alignItems: 'center'}}><Avatar style={{backgroundColor: "#2a8afa", textAlign: 'center'}}>{user.defaultAvatar}</Avatar></GridContainer></GridItem>
                  }
                    <GridItem xs={12} sm={12} md={12} >
                    <h5 style={{margin: '0px'}} className={classes.title}>{user.firstName} {user.lastName}</h5>
                  </GridItem>
                  </GridContainer>
                <GridContainer style={{justifyContent: 'center', textAlign: 'center'}}>
                      {profile.age ?
                ...
                <GridContainer style={{justifyContent: 'center'}}>
                  ...
                  <h5 style={{margin: '0px', textAlign: 'center'}} className={classes.title}>Sports pratiqués</h5>
                  {userSports}
                  </div>
                </GridContainer>
          </GridItem>
      ...
      <GridContainer>
        ...
        <GridItem xs={12} sm={12} md={9}>
              <GridContainer>
                    <GridItem xs={12} md={8}>
                      <div>
                          <h1 style={{marginTop: '0px', marginBottom: '30px'}}>Bonjour {user.firstName}</h1>
                      </div>
                  </GridItem>
              </GridContainer>
              <GridContainer>
                ...
                <Button
                    ...
                    // target="_blank"
                    >
                    <Link to ="/add-adventure"><AddCircle style={{color: "black"}} /><span style={{color: "black"}}>Créer une aventure</span>
                    </Link>
                    </Button>
                </GridItem>
                <GridItem xs={12} md={3}>
                  <Button
                    ...
                    // target="_blank"
                    >
                    <Link to ="/add-experience"><History style={{color: "black"}}/><span style={{color: "black"}}>Ajouter une aventure passée</span>
                    </Link>
                    </Button>
                </GridItem>
              </GridContainer>
              ...
              <div className={classes.root}>
                <AppBar style={{background: '#ffffff'}}position="static">
                  <Tabs value={value} onChange={this.handleChange} inkBarContainerStyle={{backgroundColor: 'blue'}}>
                    <Tab style={{color: '#414d5d', fontSize: '11px'}} label="Informations" />
                    <Tab style={{color: '#414d5d', fontSize: '11px'}} label="Prochaines Aventures" />
                    <Tab style={{color: '#414d5d', fontSize: '11px'}} label="Précédentes Aventures" />
                    <Tab style={{color: '#414d5d', fontSize: '11px'}} label="Wish List" />
                  </Tabs>
                </AppBar>
                {value === 0 && <TabContainer>
                  <div>
                    ...
                    {/* Container Desc */}
                    <GridContainer style={{marginBottom: '20px', textAlign: 'left'}}>
                    <h6>A propos</h6>
                    <GridItem xs={12} style={{border: '1px solid rgba(232, 236, 241, 1)', paddingTop: '10px', borderRadius: '8px', display: 'table-cell', verticalAlign: 'middle'}}>
                      <div>
                        <p>{profile.desc}</p>
                      </div>
                    </GridItem>
...
export default connect(
  mapStateToProps,
  { getCurrentProfile, deleteExperience, getUserAdventures, deleteAdventure, getWishedAdventures }
