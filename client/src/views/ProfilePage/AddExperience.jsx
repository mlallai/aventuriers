            ...
            <GridContainer justify="center">
              <GridItem xs={12} sm={10} md={10}>
                <Card className={classes.cardSignup}>
                  <h2 className={classes.cardTitle}>Ajouter une expérience</h2>
                  <CardBody>
...
export default connect(mapStateToProps, { addExperience })(withStyles(signupPageStyle)(withRouter(AddExperience)));