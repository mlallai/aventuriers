  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id }).then(profile => {
      ...
      if (req.body.mainActivity)
        experienceFields.mainActivity = req.body.mainActivity;
      ...
      if (req.body.mainActivity === "Alpinisme") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874586/Alpinism.jpg"
        );
      }
      if (req.body.mainActivity === "Canyoning") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874586/Canyoning.jpg"
        );
      }
      if (req.body.mainActivity === "Cyclisme") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874586/Cycling.jpg"
        );
      }
      if (req.body.mainActivity === "Equitation") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Horse_riding.jpg"
        );
      }
      if (req.body.mainActivity === "Escalade") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874586/Climbing.jpg"
        );
      }
      if (req.body.mainActivity === "Canoë-kayak") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Kayaking.jpg"
        );
      }
      if (req.body.mainActivity === "Kitesurf") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Kitesurf.jpg"
        );
      }
      ...
      if (req.body.mainActivity === "Parachute") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874588/Parachute.jpg"
        );
      }
      if (req.body.mainActivity === "Parapente") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874588/Paragliding.jpg"
        );
      }
      if (req.body.mainActivity === "Planche à voile") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Windsurfing.jpg"
        );
      }
      if (req.body.mainActivity === "Plongée") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874586/Diving.jpg"
        );
      }
      if (req.body.mainActivity === "Randonnée") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Hiking2.jpg"
        );
      }
      if (req.body.mainActivity === "Ski") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Skiing.jpg"
        );
      }
      if (req.body.mainActivity === "Ski de fond") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874586/Ski_touring.jpg"
        );
      }
      if (req.body.mainActivity === "Ski de randonnée") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874588/Ski_touring_2.jpg"
        );
      }
      if (req.body.mainActivity === "Snowboard") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Snowboarding.jpg"
        );
      }
      if (req.body.mainActivity === "Surf") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Surf.jpg"
        );
      }
      if (req.body.mainActivity === "Trail") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Trail.jpg"
        );
      }
      if (req.body.mainActivity === "Trek") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Hiking.jpg"
        );
      }
      if (req.body.mainActivity === "Voile") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874588/Sailing.jpg"
        );
      }
      ...
      if (req.body.mainActivity === "VTT") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Mountain_bike.jpg"
        );
      }
      if (req.body.mainActivity === "Wakeboard") {
        experienceFields.defaultPictures.push(
          "https://res.cloudinary.com/adventurer/image/upload/v1546874587/Wakeboard.jpg"
        );
      }
